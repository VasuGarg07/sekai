...
export default function AnimeFilters({ onApply, setPage }: AnimeFiltersProps) {
    ...
    return (
        <form onSubmit={handleSubmit} className="bg-zinc-800 rounded-lg shadow-md sm:rounded-xl">
            {/* Header with Toggle — semantic button handles the toggle, not the div */}
            <button
                type="button"
                className="w-full flex items-center justify-between p-4 sm:p-6 hover:bg-zinc-700/50 transition-colors rounded-t-lg sm:rounded-t-xl text-left"
