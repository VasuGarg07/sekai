...
const SpotlightCarousel: React.FC = () => {
    ...
    if (isLoading) {
        return (
            <div className="relative w-full h-75 sm:h-100 lg:h-120 bg-neutral-900 flex items-center justify-center">
    ...
    if (isError) {
        return (
            <div className="relative w-full h-75 sm:h-100 lg:h-120 bg-neutral-900 flex items-center justify-center text-center px-6">
                <div>
    ...
    if (!len) {
        return (
            <div className="relative w-full h-75 sm:h-100 lg:h-120 bg-neutral-900/80 flex items-center justify-center text-center px-6">
                <div>
    ...
    return (
        <div {...handlers} className="relative w-full h-60 sm:h-100 lg:h-120 bg-neutral-900 overflow-hidden flex items-center">
